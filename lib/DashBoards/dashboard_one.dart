...
class DashboardOneScreen extends StatefulWidget {
  ...
  DashboardOneScreen({required this.username});
...
class _DashboardOneScreenState extends State<DashboardOneScreen> {
  ...
  void initState() {
    ...
    gridItems = [
      ...
      GridItem(
        icon: 'assets/images/data_list1.png',
        name: "Data List",
        onTap: () {
      ...
      GridItem(
        icon: 'assets/images/add_data1.png',
        name: "Add Data",
        onTap: () {
          // Handle Add Data tap
          _handleAddData();
      ...
      GridItem(
        icon: 'assets/images/take_picture1.png',
        name: "Take Photo",
        onTap: () {
      ...
      GridItem(
        icon: 'assets/images/sync_data1.png',
        name: "Sync Data",
        onTap: () {
        ...
        children: [
          Expanded(
            child: SingleChildScrollView(
              child: Stack(
                children: [
                  Image.asset('assets/images/app_bar1.png'), // Replace with your image asset
                  Padding(
