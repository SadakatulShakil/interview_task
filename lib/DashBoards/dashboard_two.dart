...
class DashboardTwoScreen extends StatefulWidget {
  final String username;

  DashboardTwoScreen({required this.username});
  @override
  _DashboardTwoScreenState createState() => _DashboardTwoScreenState();
}
class GridItem {
  final String icon;
  final String name;
...
class _DashboardTwoScreenState extends State<DashboardTwoScreen> {
  ...
  void initState() {
    ...
    gridItems = [
      GridItem(
        icon: 'assets/images/profile2.png',
        name: "Profile",
        onTap: () {
          // Handle Profile tap
          Navigator.push(
      ...
      GridItem(
        icon: 'assets/images/data_list2.png',
        name: "Data List",
        onTap: () {
      ...
      GridItem(
        icon: 'assets/images/add_data2.png',
        name: "Add Data",
        onTap: () {
          // Handle Add Data tap
          _handleAddData();
      ...
      GridItem(
        icon: 'assets/images/take_picture2.png',
        name: "Take Photo",
        onTap: () {
      ...
      GridItem(
        icon: 'assets/images/sync_data2.png',
        name: "Sync Data",
        onTap: () {
        ...
        children: [
          Expanded(
            child: SingleChildScrollView(
              child: Stack(
                children: [
                  Image.asset('assets/images/app_bar2.png'), // Replace with your image asset
                  Padding(
